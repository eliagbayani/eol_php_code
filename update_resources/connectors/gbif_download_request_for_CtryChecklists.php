...
php update_resources/connectors/gbif_download_request_for_NMNH.php _ '{"task":"send_download_request", "taxon":"Country_checklists"}'

This will generate the .sh file if download is ready. The .sh file is the curl command to download.
php update_resources/connectors/gbif_download_request_for_NMNH.php _ '{"task":"generate_sh_file", "taxon":"Country_checklists"}'
