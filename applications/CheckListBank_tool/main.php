...
<table border="1" cellpadding="15" cellspacing="1" align="center" width="40%">
    ...
    <tr><td>
            <font size="3">
            <b>Taxa File</b>: The file should have headers that we can use to infer the mapping for each column. <br><br>
    ...
    <tr><td>
            <font size="3">
            <b>Reference File</b>: The file should have headers that we can use to infer the mapping for each column. <br><br>
